...
<Input value ={updateText} placeholder={todo.todo.todo} fullWidth margin="normal" onChange={e =>setUpdateText(e.target.value)} style={input}/>
<Input value ={updateDate} placeholder={todo.todo.Date} fullWidth onChange={e =>setUpdateDate(e.target.value)} type="date" style={input}/>
