...
import { Card ,Modal ,Checkbox ,List ,ListItem ,ListItemText ,IconButton ,Input } from '@material-ui/core'
...
<Input value ={updateInput} placeholder={props.todo.todo} onChange={e =>setUpdate(e.target.value)}/>
