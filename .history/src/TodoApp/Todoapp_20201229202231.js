  ...
  if (todos.length === 0){
    ...
    return (
        ...
        <IconButton style={{float:'right'}} >logout<ExitToAppIcon/></IconButton>
            ...
            />
                <Input type="text"  placeholder="add your todos" onChange={handleChange} value={inputs} style={{width:"60%",margin:'auto'}}/>
                <Input type="date" onChange={(e)=>setDate(e.target.value)} style={{width:"60%",margin:'auto'}}/>
