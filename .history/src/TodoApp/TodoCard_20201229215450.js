...
<Input value ={updateText} placeholder={todo.todo.todo} onChange={e =>setUpdate(e.target.value)}/>
<Input value ={updateDate} placeholder={todo.todo.Date} onChange={e =>setUpdate(e.target.value)}/>
